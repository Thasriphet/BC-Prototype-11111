...
public class Realcam_Bird extends Activity implements SurfaceHolder.Callback
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_realcam__bird);
        ...
        mPreview.setOnClickListener(new OnClickListener() {
            public void onClick(View arg0) {
                if(!saveState) {
                    saveState = true;
                    mCamera.takePicture(Realcam_Bird.this, null, null, Realcam_Bird.this);
                }
            }
        });
    }
    ...
    public void onPictureTaken(byte[] arg0, Camera arg1) {
        ...
        try {
            ...
            os.flush();
            os.close();
            Toast.makeText(Realcam_Bird.this, fileName, Toast.LENGTH_SHORT).show();
